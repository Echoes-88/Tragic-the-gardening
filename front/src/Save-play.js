...
const play = {
    ...
    fightMoveCpter: function(cpterCard, playerCard) {
        ...
        console.log('cpter card', cpterCard, 'playerCard', playerCard)
    ...
    fight: function(attacker, defenser, attackerBoard, defenserBoard) {
        ...
        setTimeout(function(){ 
            ...
            if(attackerCard.hit_point <= 0) {
                ...
                // delete carOnBoard
                if(defenserName === 'cpterDeck') {
                    play.state.cpterCardsOnBoard.monsters.splice(attackerCard.key, 1);
                } else {
                    play.state.playerCardsOnboard.splice(attackerCard.key, 1);
                }
            }
            ...
            if(defenserCard.hit_point <= 0) {
                ...
                // delete carOnBoard
                if(defenserName === 'cpterDeck') {
                    play.state.cpterCardsOnBoard.monsters.splice(defenserCard.key, 1);
                } else {
                    play.state.playerCardsOnboard.monsters.splice(defenserCard.key, 1);
                }
            }
